...
import { Ref, Prop, Watch, Component, Vue } from 'vue-property-decorator';
import { Diagram, GraphLinksModel } from 'gojs';

var VueDiagram = /** @class */ (function (_super) {
    __extends(VueDiagram, _super);
    function VueDiagram() {
    ...
    VueDiagram.prototype.getDiagram = function () {
        return this.divEle ? Diagram.fromDiv(this.divEle) : null;
    };
    /**
     * @internal
     */
    ...
    VueDiagram.prototype.mounted = function () {
        ...
        diagram.delayInitialization(function () {
            ...
            model.commit(function (m) {
                ...
                if (!!_this.linkDataArray && m instanceof GraphLinksModel) {
...
export { __vue_component__ as VueDiagram };
